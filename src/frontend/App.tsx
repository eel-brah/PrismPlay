...
export default function App() {
  ...
  const topPaddingClass = !hideTopBar ? "pt-16" : "";
  const activeSection =
              ...
              element={
                <div className={`min-h-screen ${topPaddingClass}`}>
                  <div className="max-w-4xl mx-auto px-6 py-16">
                    ...
                    <div className="flex justify-center">
                      <button
                        onClick={() => navigate("/offline")}
                        className="group w-full max-w-xl text-left rounded-3xl bg-white/[0.05] border border-white/10 backdrop-blur-xl p-7 hover:border-blue-400/40 hover:scale-[1.02] transition-all"
                      >
                        <div className="flex items-center gap-4 mb-5">
                          <div
                            className="w-14 h-14 rounded-2xl flex items-center justify-center
                ...
                group-hover:scale-110 transition"
                        ...
                        <ul className="text-sm text-gray-300 space-y-1 mb-6">
                          ...
                          <li>• Two players on one device</li>
                          <li>• Adjustable difficulty</li>
