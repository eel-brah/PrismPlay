  ...
  return (
    <Routes>
            ...
            <div className="flex flex-col items-center justify-center p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
                <div className="bg-gray-800/80 backdrop-blur-lg rounded-2xl p-6 shadow-2xl border border-gray-700">
                  ...
                  <button
                    onClick={() => navigate(sessionMode === "guest" ? "/guest" : "/landing")}
      ...
      <Route
        path="/offline"
        element={
          <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex items-center justify-center p-8">
            <Pong
              onReturn={() =>
