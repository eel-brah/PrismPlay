...
{/* 
          ...
          >
            <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
              <path fill="#EA4335" d="M24 9.5c3.52 0 6.72 1.3 9.22 3.44l6.9-6.9C35.56 2.56 29.98 0 24 0 14.62 0 6.4 5.38 2.5 13.2l8.04 6.24C12.63 13.37 17.9 9.5 24 9.5z"/>
              <path fill="#4285F4" d="M46.5 24.5c0-1.56-.14-3.06-.41-4.5H24v9h12.7c-.55 2.96-2.21 5.46-4.7 7.14l7.22 5.61C43.55 37.83 46.5 31.66 46.5 24.5z"/>
              <path fill="#FBBC05" d="M10.54 19.44L2.5 13.2C0.9 16.27 0 19.74 0 23.5c0 3.68.88 7.1 2.43 10.14l8.27-6.42c-.64-1.9-.99-3.93-.99-6.28 0-1.06.1-2.12.33-3.5z"/>
              <path fill="#34A853" d="M24 47c6.5 0 12-2.14 16.25-5.75l-7.22-5.61c-2.02 1.38-4.62 2.18-7.53 2.18-6.07 0-11.22-3.86-13.09-9.21l-8.27 6.42C6.35 42.87 14.52 47 24 47z"/>
