                  ...
                  {(chatMode === "channel"
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          className={`px-4 py-2 rounded-2xl text-white max-w-full min-w-0 ${
                            isMe
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className={`px-3 py-1 rounded-md ${g.joined ? "bg-gray-800/80 hover:bg-gray-800 text-gray-200" : "bg-blue-600 hover:bg-blue-700 text-white"}`}
                        >
                          {g.joined ? "Leave" : "Join"}
                        </button>
                      </div>
