        ...
        <div className="space-y-6 text-gray-200">
          <section className="rounded-3xl border border-white/10 bg-white/[0.03] p-6 shadow-xl">
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li>
                Account details such as username, email address, and authentication
                tokens to keep your session secure.
              </li>
              <li>
                Gameplay data including match results, leaderboards, achievements,
                and room history to power competitive features.
              </li>
              <li>
                Social data such as friend relationships and chat messages so you
                can communicate and connect with other players.
              </li>
              <li>
                Technical data like device type, browser, and basic diagnostics to
                keep the service stable and responsive.
              </li>
            </ul>
          </section>
          ...
          <section className="rounded-3xl border border-white/10 bg-white/[0.03] p-6 shadow-xl">
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li>Deliver game sessions, matchmaking, and leaderboard rankings.</li>
              <li>Maintain your account, profile, and saved progress.</li>
              <li>Enable social features, including friend requests and chat.</li>
              <li>Improve performance, balance, and security across the platform.</li>
            </ul>
          </section>
          ...
          <section className="rounded-3xl border border-white/10 bg-white/[0.03] p-6 shadow-xl">
            ...
            <p className="text-sm text-gray-300 leading-relaxed">
              ...
              If you delete your account, we remove or anonymize personal data
              unless we are required to keep it for legal, security, or fraud
              prevention purposes.
            </p>
          </section>
